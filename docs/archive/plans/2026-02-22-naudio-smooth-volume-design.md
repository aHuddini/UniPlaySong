...
`SmoothVolumeSampleProvider` moved from the per-song chain to the persistent layer (between mixer output and WaveOutEvent). See [NAUDIO_PIPELINE.md](../../dev_docs/features/NAUDIO_PIPELINE.md) for full architecture.
