...
- **Two Bundled Ambient tracks from Mike Aniki** (Hub OST, Login OST) — composer of the Aniki ReMake theme. Pick from Settings → Playback → Default Music Source → Bundled Ambient. Attribution in `NOTICES.txt`.
