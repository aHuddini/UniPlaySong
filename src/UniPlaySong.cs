...
namespace UniPlaySong
{
    ...
    public class UniPlaySong : GenericPlugin
    {
        ...
        private Services.LibraryMaintenanceService _maintenance;
        ...
        public UniPlaySong(IPlayniteAPI api) : base(api)
        {
            ...
            // Absolute first suppression — before settings, before anything.
            // Process-wide SDL2 mixer halt kills whatever Playnite is playing right now.
            if (IsFullscreen)
            {
        ...
        public override void OnApplicationStarted(OnApplicationStartedEventArgs args)
        {
            ...
            // In fullscreen mode: suppress native music (final authoritative call) and
...
#pragma warning restore CS0618
        ...
        private void InitializeServices()
        {
            ...
            _maintenance = new Services.LibraryMaintenanceService(
                _api, _fileLogger, _gamesPath,
                () => _fileService, () => _playbackService, () => _trailerAudioService);
        ...
        // Necessary to kill Playnite's native fullscreen music. Multiple calls spread across
        // startup (see constructor + InitializeServices + OnApplicationStarted). No better pattern found.

        // Alternate approach (unused): inheritance walk + preemptive zero-set. Kept as fallback.
        ...
        //     {
        //         var mainModel = GetMainModel();
        //         if (mainModel?.App == null) return;
        //         var appType = ((object)mainModel.App).GetType();
        ...
        //         if (backgroundMusicProperty == null) return;
...
#pragma warning restore CS0618
        ...
        public List<(string filePath, TimeSpan duration, long fileSize, string gameFolder)> GetLongSongs(int maxMinutes, GlobalProgressActionArgs progressArgs = null)
            => _maintenance.GetLongSongs(maxMinutes, progressArgs);
        ...
        public (int deletedFiles, long freedBytes, bool success) DeleteLongSongs(List<(string filePath, TimeSpan duration, long fileSize, string gameFolder)> longSongs, GlobalProgressActionArgs progressArgs = null)
            => _maintenance.DeleteLongSongs(longSongs, progressArgs);

        // Below stays on the plugin: settings reset/import touches the live settings object and
