...
class OggFileReader : WaveStream, ISampleProvider
{
    ...
    public override long Length =>
        (long)(_reader.TotalTime.TotalSeconds * _waveFormat.AverageBytesPerSecond);
    ...
    // WaveStream.Read — required by base class but not used when consumed as ISampleProvider
